...
public:
    double angle[3];
    Thetas(double angle_0 = 0, double angle_1 = 0, double angle_2 = 0)
    {
        this->angle[0] = angle_0;
        this->angle[1] = angle_1;
        this->angle[2] = angle_2;
    }
    Thetas &operator=(const double angles[3]);
    Thetas(const double angles[3]);
};
...
public:
    ...
    double y;
    double z;
    Position3(double x = 0, double y = 0, double z = 0)
    {
        this->x = x;
        this->y = y;
        this->z = z;
...
void value_limit(double &val, double min, double max);
